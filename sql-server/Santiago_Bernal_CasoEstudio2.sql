...
--    departamento. El resultado estará ordenado alfabéticamente de menor a mayor por los apellidos y el 
--    nombre.
...
--     en ningún curso escolar. El resultado debe mostrar el nombre del departamento y el nombre de la 
--     asignatura que no se haya impartido nunca.


-- 13. Devuelve el número total de alumnas que hay.
SELECT COUNT(*) AS 'número total de alumnas' FROM alumno
WHERE SEXO = 'M'
...
-- 15. Calcula cuántos profesores hay en cada departamento. El resultado sólo debe mostrar dos columnas, una 
...
-- 16. Devuelve un listado con todos los departamentos y el número de profesores que hay en cada uno de 
...
-- 17. Devuelve un listado con el nombre de todos los grados existentes en la base de datos y el número de 
...
SELECT g.nombre, COUNT(asi.id) as 'nùmero de asignaturas' FROM grado g
